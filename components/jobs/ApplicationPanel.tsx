...
export default function ApplicationPanel({
  ...
  return (
    <div ref={containerRef} className="rounded-[36px] border border-slate-200 bg-white p-6 shadow-[0_20px_60px_rgba(15,23,42,0.06)] md:p-7">
      <div className="text-[11px] font-black uppercase tracking-[0.24em] text-slate-400">Application</div>

      {submitted ? (
        <div className="mt-4 rounded-[28px] bg-emerald-50 p-5 text-emerald-900">
          ...
          <p className="mt-3 text-sm font-semibold leading-relaxed text-emerald-900/85">
            Your application is now in the pipeline. You can track it from your applications page.
          </p>
          <Link
            href="/applications"
            className="mt-4 inline-flex items-center gap-2 rounded-full bg-emerald-700 px-4 py-2 text-sm font-black text-white transition hover:bg-emerald-800"
          >
        ...
        <div className="mt-4 rounded-[28px] bg-slate-950 p-5 text-white">
          ...
          <Link
            href={loginHref}
            className="mt-4 inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-black text-slate-950 transition hover:bg-slate-100"
          >
            Sign in to apply
            <ArrowRight size={15} />
          </Link>
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-4">
          <p className="text-sm font-semibold leading-relaxed text-slate-600">
            Keep it simple: upload your CV and add only the context that helps the hiring team review you faster.
          </p>
          ...
          <div>
            ...
            <input
              ...
              className="mt-2 w-full rounded-2xl border border-slate-200 px-4 py-3 text-sm font-semibold text-slate-900 outline-none transition focus:border-slate-900"
              required
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="mt-2 w-full resize-none rounded-2xl border border-slate-200 px-4 py-3 text-sm font-semibold leading-relaxed text-slate-900 outline-none transition focus:border-slate-900"
            />
          </div>

          <div className="rounded-[28px] border border-dashed border-slate-200 bg-slate-50 p-5">
            <div className="flex items-center gap-2 text-sm font-black text-slate-900">
              <UploadCloud size={16} className="text-amber-700" />
              Upload your CV
            </div>
            <label className="mt-4 flex cursor-pointer flex-col gap-2 rounded-2xl bg-white px-4 py-4 text-sm font-semibold text-slate-600 shadow-sm transition hover:bg-slate-50">
